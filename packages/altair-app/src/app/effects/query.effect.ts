...
export class QueryEffects {
    ...
    downloadResult$: Observable<queryActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    startSubscription$: Observable<queryActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    stopSubscription$: Observable<queryActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    prettifyQuery$: Observable<queryActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    compressQuery$: Observable<queryActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    exportSDL$: Observable<Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    copyAsCurl$: Observable<Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    convertToNamedQuery$: Observable<Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    refactorQuery$: Observable<Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    showDonationAlert$: Observable<Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    startStreamClient$: Observable<streamActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    stopStreamClient$: Observable<streamActions.Action> = createEffect(() => {
      return this.actions$
        .pipe(
    ...
    setDynamicWindowTitle$: Observable<layoutActions.SetWindowNameAction> = createEffect(() => {
      return this.actions$
        .pipe(
