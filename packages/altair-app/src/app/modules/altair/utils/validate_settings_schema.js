    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (valid1) {
        ...
        if (valid1) {
          ...
          if (valid1) {
            if (data['beta.disable.newEditor'] === undefined) {
              valid1 = true;
            } else {
              var errs_1 = errors;
            ...
            if (valid1) {
              if (data['beta.disable.newScript'] === undefined) {
                valid1 = true;
              } else {
                var errs_1 = errors;
                if (typeof data['beta.disable.newScript'] !== "boolean") {
                  validate.errors = [{
                    keyword: 'type',
                    dataPath: (dataPath || '') + '[\'beta.disable.newScript\']',
                    schemaPath: '#/properties/beta.disable.newScript/type',
                    params: {
                      type: 'boolean'
                    },
                    message: 'should be boolean'
                ...
                if (valid1) {
                  ...
                  if (valid1) {
                    ...
                    if (valid1) {
                      ...
                      if (valid1) {
                        if (data.enableTablistScrollbar === undefined) {
                          valid1 = true;
                        } else {
                          var errs_1 = errors;
                          if (typeof data.enableTablistScrollbar !== "boolean") {
                            validate.errors = [{
                              keyword: 'type',
                              dataPath: (dataPath || '') + '.enableTablistScrollbar',
                              schemaPath: '#/properties/enableTablistScrollbar/type',
                              params: {
                                type: 'boolean'
                              },
                              message: 'should be boolean'
                              ...
                              if (valid1) {
                                ...
                                if (valid1) {
                                  ...
                                  if (valid1) {
                                    ...
                                    if (valid1) {
                                      var data1 = data['script.allowedCookies'];
                                      if (data1 === undefined) {
                                        valid1 = true;
                                      } else {
                                        var errs_1 = errors;
                                        if (Array.isArray(data1)) {
                                          ...
                                          for (var i1 = 0; i1 < data1.length; i1++) {
                                            ...
                                            if (typeof data1[i1] !== "string") {
                                              validate.errors = [{
                                                keyword: 'type',
                                                dataPath: (dataPath || '') + '[\'script.allowedCookies\'][' + i1 + ']',
                                                schemaPath: '#/properties/script.allowedCookies/items/type',
                                                params: {
                                                  type: 'string'
                                                },
                                                message: 'should be string'
                                          ...
                                          validate.errors = [{
                                            keyword: 'type',
                                            dataPath: (dataPath || '') + '[\'script.allowedCookies\']',
                                            schemaPath: '#/properties/script.allowedCookies/type',
                                            params: {
                                              type: 'array'
                                            },
                                            message: 'should be array'
