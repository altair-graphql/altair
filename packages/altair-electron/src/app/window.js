        ...
        responseHeaders: Object.assign(
          ...
          details.responseHeaders,
          {
            ...
            'Content-Security-Policy': [
              ...
              // `script-src 'self' 'sha256-1Sj1x3xsk3UVwnakQHbO0yQ3Xm904avQIfGThrdrjcc=' '${createSha256CspHash(renderInitialOptions())}' https://cdn.jsdelivr.net http://localhost:*; object-src 'self';`
            ]
          }
        )
      });
